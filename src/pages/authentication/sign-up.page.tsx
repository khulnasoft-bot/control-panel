...
function TermsOfServices() {
  const tos = (children: React.ReactNode) => (
    <ExternalLink openInNewTab href="https://www.snipkit.com/docs/legal/terms" className="underline">
      {children}
    </ExternalLink>
  );
  ...
  const privacy = (children: React.ReactNode) => (
    <ExternalLink
      openInNewTab
      href="https://www.snipkit.com/docs/legal/data-processing-agreement"
      className="underline"
    >
      {children}
    </ExternalLink>
