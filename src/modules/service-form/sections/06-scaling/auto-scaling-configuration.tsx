...
import { InputEnd, Slider, Tooltip } from '@snipkit/design-system';
      ...
      <T
        ...
        values={{
          announcement: (children) => (
            <ExternalLink
              openInNewTab
              href="https://snipkit.com/blog/scale-to-zero-optimize-gpu-and-cpu-workloads"
              className="underline"
            >
              {children}
            </ExternalLink>
          ...
          feedback: (children) => (
            <ExternalLink openInNewTab href="https://community.snipkit.com" className="underline">
              {children}
            </ExternalLink>
          ),
        }}
